...
namespace Death_Spells {
	...
	void Summon_Skeleton(float x, float y) {
		...
		scene.get<animation>(skeleton0).sheet = { //populate the vector
			...
			{ {1536, 0, 128, 128}, 1536, 512,  0, 0, {60, 95}, 75.0f, 75.0f},//atack
			{ {2048, 0, 128, 128}, 2048, 512,  0, 0, {60, 95}, 75.0f, 75.0f},
			{ {2560, 0, 128, 128}, 2560, 256,  0, 0, {60, 95}, 75.0f, 75.0f},
		...
		scene.get<Actions>(skeleton0).frameCount = { {0, 0}, { 4, 0}, {8, 0}, {4, 0}, {4,0}, {2,0}, {5,0}, {4,0} };
